...
const events = [
    ...
    {"id": "asc-01", poi: "All Saints Church", when: new Date(2019, jul, 6, 11), timeSpecified: 1, title: "Family Fun Day",
        ...
        url: "https://www.facebook.com/events/382254675719310/", price: "Free"},
    ...
    {"id": "brc-01", poi: "Blackheath Rugby Club", when: new Date(2019, jul, 10, 20), timeSpecified: 1,
        ...
        url: "https://sites.google.com/site/folkmobonline/folkmob-calendar-1?authuser=0", price: "Free"},
    ...
    {"id": "rb-08", poi: "The Rusty Bucket Pub", when: new Date(2019, jul, 7, 18), timeSpecified: 1, title: "Live Music: Eva & Nino", price: "Free"},
    {"id": "rb-09", poi: "The Rusty Bucket Pub", when: new Date(2019, jul, 14, 18), timeSpecified: 1, title: "Live Music: Sound Refuge", price: "Free"},
    {"id": "rb-11", poi: "The Rusty Bucket Pub", when: new Date(2019, jul, 21, 18), timeSpecified: 1, title: "Live Music: Marcopiccioni Trio - blues, jazz & Rock", price: "Free"},
    {"id": "rb-12", poi: "The Rusty Bucket Pub", when: new Date(2019, jul, 28, 18), timeSpecified: 1, title: "Live Music: Dom & James - local band - 90's acoustic indie rock", price: "Free"},
    ...
    {"id": "rb-16", poi: "The Rusty Bucket Pub", when: new Date(2019, jul, 30), timeSpecified: 0, title: "Boardgame Night", price: "Free"},
    {"id": "rb-17", poi: "The Rusty Bucket Pub", when: new Date(2019, aug, 4), timeSpecified: 0, title: "Live Music - Missouri Gutts (band)", price: "Free"},
    {"id": "rb-18", poi: "The Rusty Bucket Pub", when: new Date(2019, aug, 6, 20), timeSpecified: 1, title: "Music Quiz.", price: "£2 entry per person."},

    {"id": "owc-01", poi: "Oxleas Wood Cafe", when: new Date(2019, aug, 4, 15), timeSpecified: 1, title: "Live Music - Gambler", price: "Free"},
    {"id": "owc-02", poi: "Oxleas Wood Cafe", when: new Date(2019, aug, 11, 15), timeSpecified: 1, title: "Live Music - Gordon Webber & Steve Mac", shortDesc: "Harmony vocals and acoustic guitars.", price: "Free"},
    {"id": "owc-03", poi: "Oxleas Wood Cafe", when: new Date(2019, aug, 25, 15), timeSpecified: 1, title: "Oxlea Hill Carnival: Marie Dawn & JJBand", shortDesc: "Classic reggae.  BBQ jerk chicken.  Beers, ales and gins.", price: "Free"},
    {"id": "owc-04", poi: "Oxleas Wood Cafe", when: new Date(2019, aug, 26, 15), timeSpecified: 1, title: "Oxlea Hill Carnival: Al Keval", shortDesc: "Ska and reggae band.  BBQ jerk chicken.  Beers, ales and gins.", price: "Free"},
    {"id": "owc-05", poi: "Oxleas Wood Cafe", when: new Date(2019, sep, 1, 15), timeSpecified: 1, title: "Live Music - Shawthing", price: "Free"},
    {"id": "owc-06", poi: "Oxleas Wood Cafe", when: new Date(2019, sep, 8, 15), timeSpecified: 1, title: "Live Music - Marilyn Gentle Trio", shortDesc: "Acoustic soul, jazz, latin and pop... re-imagined.", price: "Free"},
    {"id": "owc-07", poi: "Oxleas Wood Cafe", when: new Date(2019, jul, 7, 15), timeSpecified: 1, title: "Live Music - Marco Meloni - acoustic guitar", price: "Free"},
    {"id": "owc-08", poi: "Oxleas Wood Cafe", when: new Date(2019, jul, 14, 15), timeSpecified: 1, title: "Live Music - Gambler", shortDesc: "A highly recommended rock and soul band of first-class musicians.", price: "Free"},
    {"id": "owc-09", poi: "Oxleas Wood Cafe", when: new Date(2019, jul, 21, 15), timeSpecified: 1, title: "Live Music - American \"Hot Rod\" - Detonators Rockabilly Band", price: "Free"},
    {"id": "owc-10", poi: "Oxleas Wood Cafe", when: new Date(2019, jul, 28, 15), timeSpecified: 1, title: "Live Music - Be Sharp", shortDesc: "A steaming guitar-based trio.  And a BBQ!", price: "Free"},
    ...
    {"id": "ep-03", poi: "Eltham Palace", when: new Date(2019, jul, 7, 12), timeSpecified: 1, title: "Lazy Jazz Sunday", shortDesc: "Join us for a lazy Sunday and enjoy jazz music in the stunning surroundings of Eltham Palace and Gardens.  Performances at 12pm, 1pm, 2pm & 3pm", url: "https://www.english-heritage.org.uk/visit/whats-on/eltham-queer-walls-21-june-2019/", price: "Free"},
    ...
    {"id": "whp-01", poi: "Well Hall Pleasaunce", when: new Date(2019, jun, 9, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html", price: "Free"},
    {"id": "whp-02", poi: "Well Hall Pleasaunce", when: new Date(2019, jun, 16, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html", price: "Free"},
    {"id": "whp-03", poi: "Well Hall Pleasaunce", when: new Date(2019, jun, 23, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html", price: "Free"},
    {"id": "whp-04", poi: "Well Hall Pleasaunce", when: new Date(2019, jun, 30, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html", price: "Free"},
    {"id": "whp-05", poi: "Well Hall Pleasaunce", when: new Date(2019, jul, 7, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html", price: "Free"},
    //future
    {"id": "whp-06", poi: "Well Hall Pleasaunce", when: new Date(2019, jul, 14, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html", price: "Free"},
    {"id": "whp-07", poi: "Well Hall Pleasaunce", when: new Date(2019, jul, 21, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html", price: "Free"},
    {"id": "whp-08", poi: "Well Hall Pleasaunce", when: new Date(2019, jul, 28, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html", price: "Free"},

    {"id": "eps-01", poi: "Eltham Park South", when: new Date(2019, jun, 30, 15), timeSpecified: 1, title: "Concert in the Park", url: "http://parksfest.org/calendar.html", price: "Free"},
    {"id": "eps-02", poi: "Eltham Park South", when: new Date(2019, jul, 7, 15), timeSpecified: 1, title: "Concert in the Park", url: "http://parksfest.org/calendar.html", price: "Free"},
    {"id": "eps-03", poi: "Eltham Park South", when: new Date(2019, jul, 21, 15), timeSpecified: 1, title: "Concert in the Park", url: "http://parksfest.org/calendar.html", price: "Free"},
