...
const events = [
    ...
    //Every Wednesday
    {"id": "brc-01", poi: "Blackheath Rugby Club", when: new Date(2019, jun, 19, 20), timeSpecified: 1, title: "Folk Mob Open-Mic Night", shortDesc: "An open-mic night with the Folk Mob - come and play or just watch and listen.", url: "https://sites.google.com/site/folkmobonline/folkmob-calendar-1?authuser=0"},
    {"id": "brc-02", poi: "Blackheath Rugby Club", when: new Date(2019, jun, 26, 20), timeSpecified: 1, title: "Folk Mob Open-Mic Night", shortDesc: "An open-mic night with the Folk Mob - come and play or just watch and listen.", url: "https://sites.google.com/site/folkmobonline/folkmob-calendar-1?authuser=0"},
    ...
    {"id": "sc-02", poi: "Severndroog Castle", when: new Date(2019, jul, 12), timeSpecified: 0, title: "A Theatrical Opera Night", shortDesc: "Explore and enjoy the Castle after hours whist listening to enticing Opera arias at one of our summer late night openings.", url: "https://www.severndroogcastle.org.uk/OperaLate.html"},
    ...
    {"id": "tb-04", poi: "Tudor Barn", when: new Date(2019, jul, 22, 11), timeSpecified: 1, title: "Wedding Fair", shortDesc: "Over 30 suppliers of err... wedding stuff.", url: "http://www.tudorbarneltham.com/event/10009"},
    ...
    {"id": "sh-08", poi: "Shrewsbury House", when: new Date(2019, jul, 20, 12), timeSpecified: 1, title: "Summer Fete and Craft Fair", shortDesc: "Lots to see and do for the whole family plus a wide range of stall holders selling all sorts of handmade goods.", url: "https://shrewsburyhouse.org/events/events/summer-fete-and-craft-fair/"},
    ...
    {"id": "gmg-02", poi: "Gerald Moore Gallery", when: new Date(2019, jul, 10, 9,  30), timeSpecified: 1, title: "Kids Summer Art Day: Paint!", shortDesc: "Explore the world of paint in this jam packed day of colours. For ages 6-10. £50 for the whole day.", url: "https://bookwhen.com/geraldmooregallery%20#focus=ev-socb-20190710093000"},
    ...
    {"id": "owc-03", poi: "Oxleas Wood Cafe", when: new Date(2019, aug, 25, 15), timeSpecified: 1, title: "Oxlea Hill Carnival: Marie Dawn & JJBand", shortDesc: "Classic reggae.  BBQ jerk chicken.  Beers, ales and gins."},
    ...
    {"id": "whp-01", poi: "Well Hall Pleasaunce", when: new Date(2019, jun, 9, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html"},
    {"id": "whp-02", poi: "Well Hall Pleasaunce", when: new Date(2019, jun, 16, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html"},
    {"id": "whp-03", poi: "Well Hall Pleasaunce", when: new Date(2019, jun, 23, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html"},
    {"id": "whp-04", poi: "Well Hall Pleasaunce", when: new Date(2019, jun, 30, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html"},
    {"id": "whp-05", poi: "Well Hall Pleasaunce", when: new Date(2019, jul, 7, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html"},
    {"id": "whp-06", poi: "Well Hall Pleasaunce", when: new Date(2019, jul, 14, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html"},
    {"id": "whp-07", poi: "Well Hall Pleasaunce", when: new Date(2019, jul, 21, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html"},
    {"id": "whp-08", poi: "Well Hall Pleasaunce", when: new Date(2019, jul, 28, 15), timeSpecified: 1, title: "Summer Sunday Music", url: "http://parksfest.org/calendar.html"},

    {"id": "eps-01", poi: "Eltham Park South", when: new Date(2019, jun, 30, 15), timeSpecified: 1, title: "Concert in the Park", url: "http://parksfest.org/calendar.html"},
    {"id": "eps-02", poi: "Eltham Park South", when: new Date(2019, jul, 7, 15), timeSpecified: 1, title: "Concert in the Park", url: "http://parksfest.org/calendar.html"},
    {"id": "eps-03", poi: "Eltham Park South", when: new Date(2019, jul, 21, 15), timeSpecified: 1, title: "Concert in the Park", url: "http://parksfest.org/calendar.html"},
    ...
    {"id": "nem-02", poi: "New Eltham Methodist Church", when: new Date(2019, jul, 6, 19, 30), timeSpecified: 1, title: "Barn Dance", shortDesc: "Price: £10 for adults, £2.50 for kids - including a ploughman's lunch!", url: "http://www.necp.org.uk/next-event-1/4590253811"},
